...
@Component({
    selector: 'app-style-lines-with-a-data-driven-property',
    templateUrl: './style-lines-with-a-data-driven-property.component.html',
    styleUrls: ['./style-lines-with-a-data-driven-property.component.css']
})
export class StyleLinesWithADataDrivenPropertyComponent {
